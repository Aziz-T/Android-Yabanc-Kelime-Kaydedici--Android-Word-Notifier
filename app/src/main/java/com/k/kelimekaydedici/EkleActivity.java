...
public class EkleActivity extends AppCompatActivity {
    private EditText kelimeEdit,ceviriEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kelimeEdit=findViewById(R.id.kelimeEdit);
        ceviriEdit=findViewById(R.id.ceviriEdit);
        ...
        kaydet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("kelime",kelimeEdit.getText().toString());
                intent.putExtra("cevirisi",ceviriEdit.getText().toString());
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (!recognizer.isOperational()) {
                    ...
                    kelimeEdit.setText(sb.toString());
                }
